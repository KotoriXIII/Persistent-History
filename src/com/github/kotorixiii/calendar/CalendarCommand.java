...
import com.github.kotorixiii.util.Fanciful.mkremins.fanciful.FancyMessage;
...
import static com.github.kotorixiii.PersistentHistory.*;
import static com.github.kotorixiii.util.PHMaps.senderEventDesc;
import static com.github.kotorixiii.util.PHMaps.senderEventTitle;
import static com.github.kotorixiii.util.PHStrings.*;
...
public class CalendarCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String s, String[] args) {
        ...
        switch (cmd.getName()) {
            ...
            case "calendar":
                ...
                Permission calendarAdminPerm = new Permission("phistory.calendar.admin");
                Permission standardPerm = new Permission("phistory.calendar");
                Permission listPerm = new Permission("phistory.calendar.list");
                ...
                if (!sender.hasPermission(calendarAdminPerm) && !sender.hasPermission(standardPerm)) {
                    sender.sendMessage(phprefix + nopermscolor + " You have no permission " + nopermsparenthesis + "(" + nopermsidentity +
                            standardPerm.getName() + nopermsparenthesis + ")" + nopermscolor + " to access this command.");
    ...
    public void createEventTitleThread(CommandSender sender, int expiration) {
        new BukkitRunnable() {
            int i = 0;
