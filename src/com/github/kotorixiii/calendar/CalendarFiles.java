...
import static com.github.kotorixiii.PersistentHistory.pCalendar;
import static com.github.kotorixiii.PersistentHistory.plugin;
...
public class CalendarFiles {
    ...
    public CalendarFiles() {
        ...
        File persistent_history_folder = plugin.getDataFolder();
        persistent_history_folder.mkdir();
    ...
    public void buildCalendar() {
        ...
        if (!newDayAlert.exists()) {
            saveResource("com\\github\\kotorixiii\\calendar\\audio\\newDayAlert.nbs", "newDayAlert.nbs", calendar_audio_folder, false);
        }

        if (!eventAlert.exists()) {
            saveResource("com\\github\\kotorixiii\\calendar\\audio\\eventAlert.nbs", "eventAlert.nbs", calendar_audio_folder, false);
        }

        if (!calendar_settings_file.exists()) {
            saveResource("com\\github\\kotorixiii\\calendar\\resources\\settings.yml", "settings.yml", calendar_folder, false);
        }
